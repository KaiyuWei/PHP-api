...
- run all the migration scripts in `/database/migrations` by `composer run:migrations` for creating tables needed in your database. There are also some seeders available in `/database/seeders` folder for seeding some dummy data for testing.
